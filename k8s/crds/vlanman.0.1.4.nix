    ...
    "vlanman.dialo.ai.v1.VlanNetworkSpec" = {
      options = {
        "localGatewayIp" = mkOption {
          description = "LocalGatewayIP specifies the IP address of the local gateway for the VLAN network";
          type = types.nullOr types.str;
        };
        "localSubnet" = mkOption {
          description = "LocalSubnet defines the list of local subnet CIDR blocks";
        ...
        "remoteGatewayIp" = mkOption {
          description = "RemoteGatewayIP specifies the IP address of the remote gateway for the VLAN network";
          type = types.nullOr types.str;
        };
        "remoteSubnet" = mkOption {
          description = "RemoteSubnet defines the list of remote subnet CIDR blocks";
          type = types.listOf types.str;
        };
        "vlanId" = mkOption {
